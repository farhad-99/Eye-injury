...
class CNN_Model(tf.keras.Model):
    ...
    def _build_final(self):
        ...
        self.fc2 = Dense(4, activation='softmax', kernel_initializer='glorot_uniform', kernel_regularizer=tf.keras.regularizers.l2(0.02))
